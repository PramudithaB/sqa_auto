...
(async () => {
  ...
  try {
    ...
    console.log("Running TC02 - Convert JPG to PNG");

    // Correct URL from screenshot
    await page.goto('https://www.pixelssuite.com/convert-to-png', {
    ...
    if (files.length > 0) {
      console.log("✅ TC02 PASSED - PNG downloaded");
    } else {
      console.log("❌ TC02 FAILED - PNG not downloaded");
    }

  } catch (error) {
    console.error("Error:", error);
    console.log("❌ TC02 FAILED");
  } finally {
